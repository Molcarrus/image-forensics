...
use crate::{NoiseResult, SRegion, error::Result, image_utils::{gaussian_blur_3x3, rgb_to_gray}};
...
impl NoiseAnalyzer {
    ...
    pub fn analyze(&self, image: &DynamicImage) -> Result<NoiseResult> {
        ...
        let (anomalous_regions, inconsistency_score) = self.find_anomlaies(&local_variance_map, estimated_noise_level);
